...
import {BoxShadow as BorderShadow} from 'react-native-shadow'
...
export const Level = ({ level, num, percent, bColor }) => {
  ...
  const s = StyleSheet.create({
      ...
      text:{
        fontSize: 21, textAlign: 'center', marginLeft: 10, flex: 4.9,
