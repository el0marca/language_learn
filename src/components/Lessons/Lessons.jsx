  ...
  return (
    <ImageBackground source={require('../../img/bg/lessonBg.png')} style={s.background}>
      <View style={{ height: '55%' }}>
        <Animated.FlatList style={{ flex: 1, justifyContent: 'flex-end', alignItems: 'flex-end', backgroundColor: 'red' }}
          ref={scrollRef}
          ...
          renderItem={({ item, index }) => {
            ...
            return (
              <Animated.View style={[{ justifyContent: 'flex-start', width: circleSize }, index == 114 && { marginRight: width * .35 }, { transform: [{ scale }, { translateY: translate }] }
            ]}>
